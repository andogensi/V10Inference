...
constexpr TensorProto_DataType TensorProto_DataType_DataType_MAX = static_cast<TensorProto_DataType>(26);
constexpr int TensorProto_DataType_DataType_ARRAYSIZE = 26 + 1;
...
constexpr Version Version_MAX = static_cast<Version>(13);
constexpr int Version_ARRAYSIZE = 13 + 1;
